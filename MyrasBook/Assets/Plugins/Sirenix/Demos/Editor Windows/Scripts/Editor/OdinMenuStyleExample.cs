...
namespace Sirenix.OdinInspector.Demos
{
    ...
    public class OdinMenuStyleExample : OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            tree.AddAllAssetsAtPath("Scriptable ScriptableObjects in Plugins Tree", "Plugins", typeof(ScriptableObject), true, false);
            tree.AddAllAssetsAtPath("Scriptable ScriptableObjects in Plugins Flat", "Plugins", typeof(ScriptableObject), true, true);
